...
export class DoctorServiceImpl implements DoctorService {
    ...
    public   createDoctor(doctorReq: DoctorReq): Promise<Doctor> {
        try{
            ...
            throw new CreationError("Failed to create doctor from service", "DoctorCreationService")
        }
    }
    ...
    public  async updateDoctor(id: number, updates: Partial<DoctorReq>): Promise<Doctor> {
        try {
            ...
            throw new UpdateError("Failed to update doctor from service", "DoctorUpdateService")
        }
    }
    ...
    public async deleteDoctor(id: number): Promise<void> {
        try {
            ...
            throw new DeleteError("Failed to delete doctor from service", "DoctorDeleteService")
        }
    }
}